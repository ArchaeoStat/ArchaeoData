...
#' \item{`beta_2_Layer_II`}{End date of Layer II.}
#' \item{`theta_5_Layer_II`}{Age of dated event 5 in Layer II.}
#' \item{`theta_4_Layer_II`}{Age of dated event 4 in Layer II.}
#' \item{`theta_3_Layer_II`}{Age of dated event 3 in Layer II.}
#' \item{`theta_2_Layer_II`}{Age of dated event 2 in Layer II.}
#' \item{`alpha_2_Layer_II`}{Start date of Layer II.}
#' \item{`beta_1_Layer_III`}{End date of Layer III.}
#' \item{`theta_1_Layer_III`}{Age of dated event 1 in Layer III.}
#' \item{`alpha_1_Layer_III`}{Start date of Layer III.}
#' \item{`phi_1`}{Floating parameter.}
#' }
#' @family datasets
#' @keywords datasets
"fishpond"
...
#'  \item{`XI`}{Layer XI.}
#'  \item{`XII`}{Layer XII.}
#'  \item{`XVI_1`}{Layer XVI 1.}
#'  \item{`XVI_2`}{Layer XVI 2.}
#'  \item{`XVI_3`}{Layer XVI 3.}
#'  \item{`XVI_4`}{Layer XVI 4.}
#'  \item{`XVII_1`}{Layer XVII 1.}
#'  \item{`XVII_2`}{Layer XVII 2.}
#'  \item{`XVII_3`}{Layer XVII 3.}
#'  \item{`XVII_4`}{Layer XVII 4.}
#'  \item{`XVIII`}{Layer XVIII.}
#'  \item{`XIX`}{Layer XIX.}
#'  \item{`XX`}{Layer XX.}
#'  \item{`XXII`}{Layer XXII.}
#' }
#' @family datasets
#' @keywords datasets
"ChronoModelEvents"
...
#' \describe{
#'  \item{`iter`}{Iteration of the MCMC algorithm.}
#'  \item{`EPI begin`}{Start date of EPI.}
#'  \item{`EPI end`}{End date of EPI.}
#'  \item{`UP begin`}{Start date of UP.}
#'  \item{`UP end`}{End date of UP.}
#'  \item{`Ahmarian begin`}{Start date of Ahmarian.}
#'  \item{`Ahmarian end`}{End date of Ahmarian.}
#'  \item{`IUP begin`}{Start date of IUP.}
#'  \item{`IUP end`}{End date of IUP.}
#' }
#' @family datasets
#' @keywords datasets
"ChronoModelPhases"
